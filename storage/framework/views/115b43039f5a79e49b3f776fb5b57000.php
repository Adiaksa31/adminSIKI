    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="text-center">
                <p class="mb-2 text-muted">Copyright &copy;
                    <script>document.write(new Date().getFullYear())</script> - PT. SIKI Revolusi Inovasi. <br> All right reserved.
                </p>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\BAYU\Downloads\adobe p\PT SIki\admin-2\adminSIKI\resources\views/partials/footer.blade.php ENDPATH**/ ?>