...
<head>
    ...
    <?php echo $__env->make('dashboard.partials.head-title-meta', ["title" => "Dashboard"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<body>
                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                <div class="flex-grow-1">
                                    <h4 class="fs-16 mb-1">Selamat <span id="greeting"></span>, <?php echo e(ucwords(Session::get('username'))); ?>!</h4>
    ...
    <!-- link js -->
     ...
     <!-- Marketplace init -->
     <script src="<?php echo e(asset('assets/js/pages/dashboard-nft.init.js')); ?>"></script>
     ...
     <script>
        $('#add-divisi').on('submit', function(e){
            ...
            $.ajax({
                ...
                url: "<?php echo e(route('add.divisi')); ?>",
                method: 'post',
                data: $(this).serialize(),
                dataType: 'json',
                beforeSend: function() {
...
<?php /**PATH C:\Users\BAYU\Downloads\adobe p\PT SIki\admin-2\adminSIKI\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>