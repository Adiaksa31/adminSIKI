...
<div class="auth-page-content">
    <div class="container">
                ...
                <div class="text-center mt-sm-5 mb-4 text-white-50">
                    <div>
                        <a href="" class="d-inline-block auth-logo">
                            <img src="<?php echo e(asset('assets/images/' . env('APP_LOGO') . 'webp')); ?>" alt="" height="100">
                        </a>
                    </div>
                        ...
                        <div class="p-2 mt-4">
                            ...
                            <form id="loginForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="position-relative auth-pass-inputgroup">
                                        <input type="password" name="password" class="form-control pe-5 password-input"
                                            onpaste="return false" placeholder="Masukkan kata sandi" id="password-input"
                                            aria-describedby="passwordInput">
                                        <button
                                            class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon"
                                            type="button" onclick="togglePasswordVisibility('password-input', this)">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" name="rememberme" id="rememberme" type="checkbox"
                                ...
                                <div class="my-3">
                                    <button id="submitButton" class="btn btn-primary w-100 fw-bold" type="submit"><span
                                            id="spinner" class="spinner-border spinner-border-sm d-none" role="status"
                                            aria-hidden="true"></span> <span id="buttonText"><i
                                                class="mdi mdi-login"></i> Masuk</span></button>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <script type="text/javascript" src="<?php echo e(asset('assets/libs/jquery/jquery-2.2.4.min.js')); ?>"></script>
        <script>
            ...
            $('#loginForm').on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('login.submit')); ?>",
                    method: 'post',
                    data: $(this).serialize(),
                    dataType: 'json',
                    beforeSend: function () {
...
<?php /**PATH C:\Users\BAYU\Downloads\adobe p\PT SIki\admin-2\adminSIKI\resources\views/login.blade.php ENDPATH**/ ?>