    ...
    if (null !== document.getElementById(e)) {
        var r =
                ...
                ("-" + document.documentElement.getAttribute("data-theme") ??
                    ""),
            r =
                document.getElementById(e).getAttribute(r) ??
    ...
    linechartBasicColors =
        (barchartColors &&
            ((options = {
                series: [
                    {
                        name: "Like",
                        data: [
                            12.45, 16.2, 8.9, 11.42, 12.6, 18.1, 18.2, 14.16,
                        ],
                    },
                    {
                        name: "Share",
                        data: [
                            -11.45, -15.42, -7.9, -12.42, -12.6, -18.1, -18.2,
                            -14.16,
                        ],
                    },
                ],
                ...
                stroke: { colors: "#000" },
                plotOptions: {
                    bar: { columnWidth: "20%", borderRadius: [4, 4] },
                },
        ...
        (linechartBasicColors &&
            ((options = {
                series: [
                    {
                        name: "Admin",
                        data: [1, 0, 0, 1, 4, 6, 9, 9, 1, 0, 0, 1],
                    },
                    {
                        name: "User",
                        data: [0, 12, 3, 4, 3, 0, 0, 0, 0, 3, 3, 7],
                    },
                    {
                        name: "Koperasi",
                        data: [5, 3, 2, 0, 0, 0, 0, 4, 2, 4, 4, 1],
                    },
                ],
                chart: {
                    height: 350,
