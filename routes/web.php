...
Route::middleware(['check.useragent.ip'])->group(function () {
    ...
    Route::middleware(['guestApi'])->group(function (){
        ...
        Route::get('/verify-{verify_key}', function () { return view('verify-login'); })->name('verify-login')->middleware('seed');
    ...
    Route::prefix("/admin")->group(function () {
        Route::get('/', function () { return view('dashboard.admin.admin'); })->name('admin');
    });
