                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h4 class="mb-0">Permission Category</h4>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="minimal-border w-100">
                                        @php
                                            $headersGroup = ['#', 'Nama Category', 'Aksi'];
                                        ...
                                        <x-card :title="'Permission Category'">
                                            ...
                                            <x-table id="table-category" :headers="$headersGroup" :rows="$rowsGroup" />
                                        </x-card>
                                    </div>
                                </div>
                                <!-- end col -->
